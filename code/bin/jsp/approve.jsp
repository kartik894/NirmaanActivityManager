...
<html lang="en">
  <head>
    ...
    <title>Approve Transaction - Nirmaan</title>
   ...
   <nav class="navbar navbar-default navbar-static-top" role="navigation">
    ...
    <%
      ...
      if(request.getParameter("" + j) != null) {
         ...
         Transaction.approveTransaction(tran);
    ...
    <div class="container">
      ...
      <form  role="form"  method="post" action="/approve.jsp">
        <h1 style="margin-left:50px"> Approve Transactions </h1>
