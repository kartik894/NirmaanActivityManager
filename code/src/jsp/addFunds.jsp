  ...
  <body>
   <nav class="navbar navbar-default navbar-static-top" role="navigation">
    ...
    <%
      ...
      String message ="";
        if(reason != null ) {
        double amount = 0 - Double.parseDouble(request.getParameter("amount"));
        if(amount < 0) {
    Transaction transaction = new Transaction(username,reason,amount);
    transaction.approved = true;
    transaction.modifyFunds();
    transaction.registertransaction();
    
    message = "Added " + (0-amount); }
  }
      if(reason == null) {
      reason = "";
      }
    ...
    <div class="container">
      ...
      <form class="form-signin" role="form" method="post" action="/addFunds.jsp">
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit" style="margin-top:10px">Add Funds</button>
      </form>
